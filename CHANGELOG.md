...
- changed props and variables so that the new `react-navigation` API could work with the following files: `Beauty.js`, `Header.js`, `Product.js`, `Gallery.js`, `Notifications.js`, `Product.js`, `Settings.js`, `Register.js`, `Onboarding.js`
